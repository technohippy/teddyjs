importScripts("560cdc1a.three.js","da98a5e8.poly2tri.js");
...
self.addEventListener("message",function(a){var b=[];a.data.forEach(function(a){b.push(new THREE.Vector3(a.x,a.y,a.z))});var c=new Teddy.Body(b);try{c.getMesh()}catch(d){return void self.postMessage({status:!1,error:d})}self.postMessage({status:!0,geometry:c.mesh.geometry})});
