...
var ThreeBSP = (function() {
	...
	ThreeBSP.Vertex = function( x, y, z, normal, uv ) {
		...
		this.normal = normal || new THREE.Vector3;
                if (!(this.normal instanceof THREE.Vector3)) {
                  this.normal = new THREE.Vector3().copy(this.normal);
                }
		this.uv = uv || new THREE.Vector2;
                if (!(this.uv instanceof THREE.Vector2)) {
                  this.uv = new THREE.Vector2().copy(this.uv);
                }
	};
